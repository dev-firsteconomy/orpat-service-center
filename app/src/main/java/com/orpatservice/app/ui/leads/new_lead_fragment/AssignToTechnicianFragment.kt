...
class AssignToTechnicianFragment : Fragment() {
    ...
    private var leadDataArrayList: ArrayList<RequestData> = ArrayList()
    private var tempDataArrayList: ArrayList<RequestData> = ArrayList()
    ...
    override fun onCreateView(
        ...
        setObserver()
        loadUI()
        requestLeadsViewModel.loadAssignedTechnicianLeads(pageNumber)
    ...
    private fun setObserver() {
        requestLeadsViewModel.assignedTechnicianLeadsData.observe(viewLifecycleOwner, this::getAssignedLeads)
    }
