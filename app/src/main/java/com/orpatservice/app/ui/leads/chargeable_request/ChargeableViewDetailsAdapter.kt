...
class ChargeableViewDetailsAdapter  (
    private val enquiryArrayList: ArrayList<Enquiry>,
    private val leadDataArrayList: LeadData,
    private val itemClickListener: (Int, View, ChargeableViewDetailsAdapterBinding) -> Unit,
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding: ChargeableViewDetailsAdapterBinding =
            ChargeableViewDetailsAdapterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ComplaintViewHolder(private val binding: ChargeableViewDetailsAdapterBinding) :
        ...
        fun onBind(
            ...
            leadData: LeadData,
            tatalCount: Int,
            itemClickListener: (Int, View, ChargeableViewDetailsAdapterBinding) -> Unit
        ) {
