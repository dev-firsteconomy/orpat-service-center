...
class ChargeableFinishedFragment  : Fragment() {
    ...
    private fun setObserver() {
        requestLeadsViewModel.loadChargeableLeads(pageNumber,1)
            ...
            Status.ERROR -> {
                ...
                response?.let {
                    if (it.success) {
                        ...
                        Constants.CHARGEABLE_COMPLETED_REQUEST = total.toString()

                        totalCount?.text = Constants.CHARGEABLE_COMPLETED_REQUEST
                        leadDataArrayList.clear()
                        tempDataArrayList.clear()
    ...
    fun loadTotalLead(toolbarTotalLead: TextView) {
        ...
        totalCount?.text = Constants.CHARGEABLE_COMPLETED_REQUEST.toString()
    }
