...
import com.orpatservice.app.databinding.ActivityChargeableViewDeatilsBinding
import com.orpatservice.app.databinding.AdapterAssignedDetailsBinding
import com.orpatservice.app.databinding.ChargeableViewDetailsAdapterBinding
...
class ChargeableViewDetailsActivity : AppCompatActivity(), View.OnClickListener, CameraBottomSheetDialogFragment.BottomSheetItemClick {
    ...
    private lateinit var bindingAdapter : ChargeableViewDetailsAdapterBinding
    private var pos: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityChargeableViewDeatilsBinding.inflate(layoutInflater)
        ...
        complaintAdapter = ChargeableViewDetailsAdapter(leadData.enquiries, leadData, itemClickListener = onItemClickListener)
    ...
    private val onItemClickListener: (Int, View, ChargeableViewDetailsAdapterBinding) -> Unit = { position, view, binding ->
  ...
  */
            ...
            Status.ERROR -> {
                ...
                response?.let {
                    if (it.success) {
                        ...
                        Utils.instance.popupPinUtil(this@ChargeableViewDetailsActivity,
                            it.message,
                            "",
                            true)
    ...
    private fun openDatePicker(tvDatePicker: TextView) {
        ...
        val datePickerDialog = DatePickerDialog(
            this@ChargeableViewDetailsActivity, dateSetListener, calendar
    ...
    private fun loadBottomSheetDialog() {
        ...
        fragment.bottomSheetItemClick = this@ChargeableViewDetailsActivity
