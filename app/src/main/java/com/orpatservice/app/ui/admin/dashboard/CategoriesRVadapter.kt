...
class CategoriesRVadapter(private val items: List<VideoProductCategoriesData>, private val listener: OnItemClickListener ) : RecyclerView.Adapter<CategoriesRVadapter.MyViewHolder>() {
    ...
    class MyViewHolder(private val binding: ItemCategoryBinding,val listener: OnItemClickListener) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: VideoProductCategoriesData) {
    ...
    interface OnItemClickListener {
        fun onItemClick(item: VideoProductCategoriesData)
    }
}
