...
import com.orpatservice.app.databinding.ChargeableItemRequestCardAdminBinding
import com.orpatservice.app.databinding.ItemRequestCardLeadAdminBinding
import com.orpatservice.app.utils.Constants
import java.text.SimpleDateFormat
import java.util.ArrayList

class ChargeableRequestsLeadsAdapter constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding: ChargeableItemRequestCardAdminBinding =
            ChargeableItemRequestCardAdminBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class RequestLeadViewHolder(private val binding: ChargeableItemRequestCardAdminBinding) :
