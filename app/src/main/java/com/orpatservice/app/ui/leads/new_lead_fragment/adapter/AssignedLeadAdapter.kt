...
class AssignedLeadAdapter constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding: AdapterAssignedLeadBinding =
            AdapterAssignedLeadBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class RequestLeadViewHolder(private val binding: AdapterAssignedLeadBinding) :
        ...
        fun onBind(
            ...
            if(leadData.status.equals("Technician  Assigned")){
                binding.btnChangeTechnician.visibility = View.VISIBLE
                binding.btnHideChangeTechnician.visibility = View.GONE
            }else{
                binding.btnHideChangeTechnician.visibility = View.VISIBLE
                binding.btnChangeTechnician.visibility = View.GONE
            }
            ...
            binding.btnChangeTechnician.setOnClickListener {
                itemClickListener(
                    adapterPosition,
                    binding.btnChangeTechnician
                )
            }
            binding.btnHideChangeTechnician.setOnClickListener {
                itemClickListener(
                    adapterPosition,
                    binding.btnHideChangeTechnician
                )
            }
