...
class CompletedDetailsAdapter (
    private val enquiryArrayList: ArrayList<Enquiry>,
    private val leadDataArrayList: LeadData,
    private val itemClickListener: (Int, View, AdapterAssignedDetailsBinding) -> Unit,
    ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding: AdapterAssignedDetailsBinding =
            AdapterAssignedDetailsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ComplaintViewHolder(private val binding: AdapterAssignedDetailsBinding) :
        ...
        fun onBind(
            ...
            leadData: LeadData,
            tatalCount: Int,
            itemClickListener: (Int, View, AdapterAssignedDetailsBinding) -> Unit
        ) {
            ...
            binding.tvWarrantyListImage.visibility =  VISIBLE
 ...
 */
            ...
            binding.tvWarrantyListImage.setOnClickListener {
                itemClickListener(
                    adapterPosition,
                    binding.tvWarrantyListImage,binding
                )
            }
