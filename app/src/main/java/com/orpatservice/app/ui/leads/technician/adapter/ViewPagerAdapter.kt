...
class ViewPagerAdapter (val context: Context, val imageList:  List<String>) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val itemView: View = mLayoutInflater.inflate(R.layout.adapter_sliderscreen_image, container, false)

        // on below line we are initializing
        // our image view with the id.
        val imageView: ImageView = itemView.findViewById<View>(R.id.img_slider) as ImageView
